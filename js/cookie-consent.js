  ...
  self.props = {
    ...
    content: {
      ...
      de: {
        ...
        body:
          "Wir nutzen Cookies, um Inhalte zu personalisieren und die Zugriffe auf unsere Website zu analysieren. " +
...
var cookieConsentProps = {
  buttonPrimaryClass: "btn btn-primary", // the "accept all" buttons class, only used for styling
  buttonSecondaryClass: "btn btn-secondary hidden", // the "accept necessary" buttons class, only used for styling
  privacyPolicyUrl: "privacypolicy.html",
  autoShowModal: true, // disable autoShowModal on the privacy policy page, to make that page readable
  blockAccess: false, // set "true" to block the access to the website before choosing a cookie configuration
  position: "right", // position ("left" or "right"), if blockAccess is false
  postSelectionCallback: function () {
    console.log("Consent: ", cookieConsent.trackingAllowed())
    window.dataLayer = window.dataLayer || [];
    function gtag() {
      dataLayer.push(arguments);
    }
    gtag("js", new Date());
    gtag("config", "G-2T8GTHMK28");
  }, // callback, after the user has made his selection
  lang: navigator.language, // the language, in which the dialog is shown
  defaultLang: "en", // default language, if the `lang` is not available as translation in `content`
  content: {
    // the content in all needed languages
...
var cookieConsent = new CookieConsent(cookieConsentProps);
